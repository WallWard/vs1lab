...
var gtaLocator = (function GtaLocator(geoLocationApi) {
    ...
    var apiKey = "GSgmtsIYEr63iSzHlyV5PIGMjK8mqmhH";
    ...
    return { // Start öffentlicher Teil des Moduls ...
        ...
        updateLocation: function() {
            tryLocate(function(position){
                ...
                $("#discovery-latitude").val(getLatitude(position));
                $("#discovery-longitude").val(getLongitude(position));

                //source vom Bild wir zur URL geändert
                $("#result-img ").attr("src", getLocationMapSrc(getLatitude(position), getLongitude(position), [], 10));
